        ...
        <div className={Style.banner}>
            ...
            <div className={Style.banner_content}>
                ...
                <h2>WHAT IF YOUR CRM DID <br /><span>MORE THAN JUST</span><br /> MANAGE CUSTOMERS?</h2>
                    {/* <Image src={"/Frame 21.png"} width={682} height={412} alt="banner" /> */}
                {/* </div> */}
            ...
            <div className={Style.banner_image}>
                ...
                <Image src={"/Frame 427319105.png"} width={88} height={88} alt="banner"  className={Style.image1}/>
                ...
                <Image src={"/pic1.png"} width={75} height={75} alt="banner"  className={Style.image6} />
                {/* <div style={{display: "flex", flexDirection: "column",}}> */}
                {/* <div> */}
                

                <Image src ={"/Frame 427319127 (1).png"} width={88} height={88} alt="banner" className={Style.image4}  />
                <Image src={"/Group (4).png"} width={63} height={76} alt="banner"  className={Style.image7} />
          

                {/* </div> */}
                </div>
                <Image src={"/Frame 427319075 (1).png"} width={332} height={332} alt="banner"  className={Style.image5} />
